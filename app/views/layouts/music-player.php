...
<div class="content">
    <div class="music-container" id="music-container">
        ...
        <div class="img-container">
            <img src="<?php echo $song->getSongImageLink(); ?>" alt="music-cover" id="cover"
        </div>
        
        <div class="navigation">
            <a id="prev" class="action-btn" href="<?php echo 'music-player.php?tab='.$tab.'&page='.$page.'&entriesPerPage='.$entriesPerPage.'&index='.($songIndex-1);?>">
            ...
            <a id="next" class="action-btn" href="<?php echo 'music-player.php?tab='.$tab.'&page='.$page.'&entriesPerPage='.$entriesPerPage.'&index='.($songIndex+1);?>">
...
<!--        <script src="js/music-player.js"></script>-->
        <?php 
            include_once 'music-player.script.php';
//            echo $songIndex+1;
//            echo $song->getSongID();
        ?>
    </div>
